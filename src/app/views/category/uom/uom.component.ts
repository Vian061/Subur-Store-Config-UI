...
export class UomComponent {
  ...
  displayedColumns: string[] = ["code", "description", "sortBy", "isPutExtraFlagInReport"];
  dataSource = new MatTableDataSource<UoMModel>(DATA);
  selectedData = new SelectionModel<UoMModel>(true, []);
